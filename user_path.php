...
$userName = $_SESSION['fName']; // Assuming username is stored in session as 'fName'

// Query to fetch enrollments for this specific user WITH course titles
...
<head>
    ...
    <title>My Learning Progress - LearnSphere</title>
        ...
        <nav class="navbar">
            <div class="container">
                ...
                <div class="nav-menu">
                    ...
                    <a href="home2.php#content" class="nav-link">About</a>
                </div>
                <div class="nav-actions">
                    ...
                    <!-- Show Username since user is logged in -->
